...
const MovieDetails = () => {
    ...
    async function getMovieDetails() {
        try {
            setLoading(true);
            const movieData = await axios.get(`https://www.omdbapi.com/?apikey=${API_KEY}&i=${imdbID}`);
    ...
    if (!movie || movie.Response === "False") {
        return (
            <div className="main">
                <div className="movie-details__container">
                    <p>Movie not found.</p>
                    <Link to="/" className="movie-details__back-link">Back to Home</Link>
                </div>
            </div>
        );
    }
                ...
                <div className="movie-details__content">
                    <div className="movie-details__poster--wrapper">
                        ...
                        <div className="movie-details__info">
                            ...
                            <p className="movie-details__year"><strong>Year:</strong> {movie.Year}</p>
                            <p className="movie-details__rating">
                                <strong>Rating:</strong> {movie.imdbRating !== "N/A" ? `${movie.imdbRating}/10` : "N/A"}
                            </p>
                            <p className="movie-details__released"><strong>Released:</strong> {movie.Released}</p>
                        </div>
                    </div>
